## Student Activity Point System (SAPS) Application

The Student Activity Point System (SAPS) is a prototype management system designed to streamline the input, management, and summarization of student participation data. This application implements core CRUD (Create, Read, Update, Delete) operations integrated with a relational database.
...
- Students (Mahasiswa): Stores identity data and cumulative activity points.
